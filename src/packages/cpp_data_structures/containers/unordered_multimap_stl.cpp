/*Illustration of unordered_multimap stl*/
...
// Note: There can be duplicate in key regardless of value of data
...
/**
 * @brief Runs capacity functions for unordered_multimap
 *
 */
void run_capacity()
{
    cout << "Test empty(): ";
    unordered_multimap<int, string> mymap = {{1, "Minh"}, {2, "Nguyen"}, {3, "Tran"}};
...
/**
 * @brief Runs iterators functions for unordered_multimap
 *
 */
void run_iterators()
{
    unordered_multimap<int, string> mymap = {{1, "minh"}, {2, "nguyen"}, {3, "tran"}, {4, "binh"}};
...
/**
 * @brief Runs elements lookup functions find() for unordered_multimap
 *
 */
...
/**
 * @brief Runs elements lookup functions count() for unordered_multimap
 *
 */
void run_element_lookup_count()
{
    unordered_multimap<int, string> mymap = {{1, "minh"}, {5, "123minh"}, {2, "nguyen"}, {3, "tran"}, {4, "binh"}};
    if (mymap.count(1) > 0)
...
/**
 * @brief Runs modifiers functions for unordered_multimap
 *
 */
void run_modifiers()
{
    ...
    cout << "Test swap(): " << endl;
    unordered_multimap<int, int> map1 = {{1, 123}, {2, 234}};
    unordered_multimap<int, int> map2 = {{3, 345}, {4, 456}};
    map1.swap(map2);
...
/**
 * @brief Runs buckets functions for unordered_multimap
 *
 */
void run_buckets()
{
...
/**
 * @brief Runs hash policy funcotion for unordered_multimap
 *
 */
